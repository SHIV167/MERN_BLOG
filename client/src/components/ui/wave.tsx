...
export function Wave({ className, fillColor = 'fill-white' }: WaveProps) {
  return (
    <div className={cn('absolute bottom-0 left-0 w-full overflow-hidden leading-none', className)}>
      <svg className="relative block w-[calc(100%+1.3px)] h-[70px] rotate-180 -mb-[0.2rem]" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
